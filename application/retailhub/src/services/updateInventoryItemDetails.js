...
export default async function updateInventoryItemDetails(requestObject) {
  try {
    ...
    const response = await fetch(
      config.URL + "updateInventoryItemDetails",
      requestOptions
    );
    ...
    console.log("Error while calling updateInventoryItemDetails service!", err);
  }
}
