...
export default async function getItemsByCategoryAndStoreId(requestObject) {
  try {
    ...
    const response = await fetch(
      config.URL + "getItemsByCategoryAndStoreId",
      requestOptions
    );
    ...
    console.log(
      "Error while calling getItemsByCategoryAndStoreId service!",
      err
    );
  }
}
