...
export default async function updateItemCategory(requestObject) {
  try {
    ...
    console.log("Error while calling updateItemCategory service!", err);
  }
}
