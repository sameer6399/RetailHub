...
export default async function getPassword(requestObject) {
  try {
    ...
    const response = await fetch(config.URL + "getPassword", requestOptions);
    ...
    console.log("Error while calling fetchData service!", err);
  }
}
