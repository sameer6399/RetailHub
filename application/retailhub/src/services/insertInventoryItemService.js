...
export default async function insertInventoryItem(requestObject) {
  try {
    ...
    const response = await fetch(
      config.URL + "insertInventoryItem",
      requestOptions
    );
    ...
    console.log("Error while calling insertInventoryItem service!", err);
  }
}
