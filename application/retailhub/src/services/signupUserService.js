...
export default async function signupUser(requestObject) {
  try {
    ...
    const response = await fetch(config.URL + "signupUser", requestOptions);
    ...
    console.log("Error while calling signupUser service!", err);
  }
}
