...
export default async function deleteInventoryItem(requestObject) {
  try {
    ...
    const response = await fetch(
      config.URL + "deleteInventoryItem",
      requestOptions
    );
    ...
    console.log("Error while calling deleteInventoryItem service!", err);
  }
}
