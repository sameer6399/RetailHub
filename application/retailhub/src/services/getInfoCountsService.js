...
export default async function getInfoCounts(requestObject) {
  try {
    ...
    const response = await fetch(config.URL + "getInfoCounts", requestOptions);
    ...
    console.log("Error while calling getInfoCounts service!", err);
  }
}
