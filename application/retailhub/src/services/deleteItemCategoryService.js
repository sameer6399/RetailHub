...
export default async function deleteItemCategory(requestObject) {
  try {
    ...
    console.log("Error while calling deleteItemCategory service!", err);
  }
}
