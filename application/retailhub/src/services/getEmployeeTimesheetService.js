...
export default async function getEmployeeTimesheet(requestObject) {
  try {
    ...
    const response = await fetch(
      config.URL + "getEmployeeTimesheet",
      requestOptions
    );
    ...
    console.log("Error while calling getEmployeeTimesheet service!", err);
  }
}
