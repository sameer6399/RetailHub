...
export default async function getTopItemCategories(requestObject) {
  try {
    ...
    const response = await fetch(
      config.URL + "getTopItemCategories",
      requestOptions
    );
    ...
    console.log("Error while calling getTopItemCategories service!", err);
  }
}
