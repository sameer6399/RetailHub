...
export default async function getAllEmployeesDetails(requestObject) {
  try {
    ...
    const response = await fetch(
      config.URL + "getAllEmployeesDetails",
      requestOptions
    );
    ...
    console.log("Error while calling getAllEmployeesDetails service!", err);
  }
}
