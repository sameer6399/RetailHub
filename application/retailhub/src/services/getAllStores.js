...
export default async function getAllStores(requestObject) {
  try {
    ...
    const response = await fetch(config.URL + "getAllStores", requestOptions);
    ...
    console.log("Error while calling getAllStores service!", err);
  }
}
