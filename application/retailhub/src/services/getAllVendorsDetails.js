...
// request object should have chain ID in it
export default async function getAllVendorsDetails(requestObject) {
  try {
    ...
    const response = await fetch(
      config.URL + "getAllVendorsDetails",
      requestOptions
    );
    ...
    console.log("Error while calling getAllVendorsDetails service!", err);
  }
}
